    ...
    return (
        <section>
            ...
            <div className="flex flex-col lg:flex-row  justify-center items-center mt-16 gap-10">
                ...
                {!isSmallScreen && (<div className="relative">
                    <video className="rounded-2xl w-96 lg:w-[450px] lg:mx-auto" ref={videoRef} loop autoPlay muted>
                    ...
                    <Accordion className="w-72 lg:w-96" type="single" collapsible>
                        <AccordionItem value="item-1" >
                            ...
                            <AccordionContent className="relative">
                                ...
                                {isSmallScreen && (<div className="relative">
                                    <video className="rounded-2xl w-96 mt-2 mb-6 lg:w-[450px] lg:mx-auto" ref={videoRef} loop autoPlay muted>
                                        <source src="https://resource.heygencdn.com/homepage/AImail_final_opt.mp4" type="video/mp4" />
                                        Your browser does not support the video tag.
                                    </video><button
                                        onClick={toggleMute}
