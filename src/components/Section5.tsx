const Section5 = () => {
    return (
        <div className="mt-10 pt-20 bg-gradient-to-r from-purple-500 to-pink-500 pb-8">
            ...
            <div className="mt-28 px-20 bg-violet-950 flex flex-col lg:flex-row mx-4 rounded-lg justify-center align-center">
                <div className="text-white mt-20 text-left mx-auto lg:px-14">
             ...
             <div className="bg-black lg:h-[400px] rounded-2xl w-96 mt-20 mx-auto lg:mr-12 mb-12 lg:mb-12">
