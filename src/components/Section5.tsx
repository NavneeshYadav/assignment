const Section5 = () => {
    return (
        <div className="mt-10 pt-20 bg-gradient-to-r from-purple-500 to-pink-500 pb-8">
            ...
            <div className="mt-28 px-20 bg-violet-950 flex flex-col lg:flex-row mx-4 lg:mx-9 rounded-lg justify-center align-center">
                <div className="text-white mt-20 text-left mx-auto lg:w-[700px] lg:pr-32">
