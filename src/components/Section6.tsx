    ...
    return (
        <section>
            <div className="flex flex-col lg:flex-row  justify-center align-center mx-64 mt-16 gap-5">
                <video className="block rounded-2xl h-96" src="https://res.cloudinary.com/diqmvbeg6/video/upload/q_auto/v1727308222/HeyGen-2.0-StreamingAvatar-1400x1600-081524_npuqow.mp4"></video>
